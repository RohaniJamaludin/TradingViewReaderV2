...
public class Product {
	...
	public void setSkipTimeSpan(int skip_time_span) {
		this.skip_time_span = skip_time_span;
	}
	
	public int getSkipTimeSpan() {
		return skip_time_span;
	}
	...
	public void setIsChartActive(boolean isChartActive) {
		this.isChartActive = isChartActive;
	}
	
	public boolean getIsChartActive() {
